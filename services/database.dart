...
import 'package:social_app/models/password_images.dart';
...
class DatabaseService {
  ...
  final StreamController<List<String>> _PasswordImageController =
  ...
  DatabaseService() {
    ...
    _firestore
        .collection('password_images')
        .snapshots()
        .listen(_password_images);
  }
  ...
  Stream<List<String>>? get passwordImages => _PasswordImageController.stream;
  ...
  void _password_images(QuerySnapshot<Map<String, dynamic>> snapshot) {
    print("password_images");
    for (var item in snapshot.docs) {
      PasswordImages passwordImages = PasswordImages.fromMap(item.data());
      List<String> Password_images_array = [];
      print(passwordImages.image1);
      Password_images_array.add(passwordImages.image1);
      Password_images_array.add(passwordImages.image2);
      Password_images_array.add(passwordImages.image3);
      Password_images_array.add(passwordImages.image4);
      Password_images_array.add(passwordImages.image5);
      Password_images_array.add(passwordImages.image6);
      Password_images_array.add(passwordImages.image7);
      Password_images_array.add(passwordImages.image8);
      _PasswordImageController.add(Password_images_array);
    }
  }
